...
export class Layout {
    ...
    getTopElement(doc: DocumentView, e: Element): Element | undefined {
        let p = e.prevSibling;
        if (p !== undefined) {
            return p
        }
    ...
    getBottomElement(doc: DocumentView, e: Element): Element | undefined {
        let p = e.nextSibling;
        if (p !== undefined) {
            return p
        }
    ...
    getLeftElement(doc: DocumentView, e: Element): Element | undefined {
        let p = e.parent;
        if (p !== undefined) {
            return p
        }
    ...
    getRightElement(doc: DocumentView, e: Element): Element | undefined {
        return e.firstChild;
    }
